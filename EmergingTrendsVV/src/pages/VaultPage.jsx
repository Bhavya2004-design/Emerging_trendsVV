  ...
  useEffect(() => {
    setFavoriteIds(currentFavorites =>
      sourceItems.reduce((accumulator, item) => {
        accumulator[item.id] =
          item.isFavorite || currentFavorites[item.id] || false;
        return accumulator;
      }, {}),
    );
  }, [sourceItems]);
        ...
        {activeTab === 'all' ? (
          <Pressable
            onPress={() =>
              Alert.alert(
                'Closet Summary',
                `${summary.savedCount} items saved and ${summary.favoritesCount} favourites in your vault.`,
              )
            }
          ...
          >
            ...
            <Text style={styles.summaryText}>
              {summary.savedCount} items saved
            </Text>
            <Text style={styles.summaryText}>
              {summary.favoritesCount} favourites
            </Text>
          </Pressable>
        ) : null}
      </View>
  ...
  return (
    <SafeAreaView edges={['top', 'left', 'right']} style={styles.safeArea}>
      <View style={styles.screen}>
        ...
        <BottomTabBar selectedTab={selectedBottomTab} onNavigate={handleBottomTabPress} />
      </View>
    </SafeAreaView>
  );
}
